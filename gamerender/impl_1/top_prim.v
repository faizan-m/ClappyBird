...
// Netlist written on Sat Apr 27 14:14:22 2019
// Source file index table: 
// Object locations will have the form @<file_index>(<first_ line>[<left_column>],<last_line>[<right_column>])
// file 0 "c:/workspace/gits/clappybird/gamerender/clap.vhd"
// file 1 "c:/workspace/gits/clappybird/gamerender/pll/rtl/pll.v"
// file 2 "c:/workspace/gits/clappybird/gamerender/testpattern.vhd"
// file 3 "c:/workspace/gits/clappybird/gamerender/top.vhd"
// file 4 "c:/workspace/gits/clappybird/gamerender/vga.vhd"
...
// file 43 "c:/workspace/gits/clappybird/gamerender/pll/rtl/core/lscc_pll.v"
...
module top (clappy, RGB, HSYNC, VSYNC, PLL_out);   /* synthesis lineinfo="@3(5[8],5[11])"*/
    ...
    LUT4 i1_4_lut (.A(n5), .B(n2016), .C(bigbird_y_pos[8]), .D(bigbird_y_pos[6]), 
         .Z(n1866)) /* synthesis lut_function=(A ((C (D))+!B)+!A !(B)) */ ;   /* synthesis lineinfo="@0(39[3],46[10])"*/
    ...
    LUT4 i370_4_lut (.A(reset), .B(n1866), .C(game_over), .D(bigbird_y_pos[9]), 
         .Z(n650)) /* synthesis lut_function=(!(A+!(B+(C+(D))))) */ ;   /* synthesis lineinfo="@0(39[3],46[10])"*/
    defparam i370_4_lut.INIT = "0x5554";
    testpattern testpattern_inst (.row_num({row_num}), .\bigbird_y_pos[6] (bigbird_y_pos[6]), 
            ...
            .GND_net(GND_net), .\bigbird_y_pos[7] (bigbird_y_pos[7]));   /* synthesis lineinfo="@3(110[20],110[31])"*/
...
module game_state (GND_net, \bigbird_y_pos[9] , \bigbird_y_pos[6] , \bigbird_y_pos[5] , 
    ...
    wire [22:0]forty_eight_mhz_counter /* synthesis is_clock=1 */ ;   /* synthesis lineinfo="@0(16[9],16[32])"*/
    wire clk /* synthesis is_clock=1 */ ;   /* synthesis lineinfo="@3(71[8],71[11])"*/
    ...
    wire n601, n632;
    wire [9:0]n45;
    wire [9:0]wait_counter;   /* synthesis lineinfo="@0(25[9],25[21])"*/
    ...
    FA2 add_1076_11 (.A0(GND_net), .B0(\bigbird_y_pos[9] ), .C0(bird_y_pos_9__N_145), 
        ...
        .D1(n2580), .CI1(n2580), .CO0(n2580), .S0(n62[10]));   /* synthesis lineinfo="@0(40[18],42[48])"*/
    ...
    FD1P3XZ bird_y_pos_i0_i5 (.D(n62[6]), .SP(n601), .CK(forty_eight_mhz_counter[19]), 
            .SR(n632), .Q(\bigbird_y_pos[5] ));   /* synthesis lineinfo="@0(39[3],46[10])"*/
    ...
    FD1P3XZ bird_y_pos_i0_i8 (.D(n62[9]), .SP(n601), .CK(forty_eight_mhz_counter[19]), 
            .SR(n632), .Q(\bigbird_y_pos[8] ));   /* synthesis lineinfo="@0(39[3],46[10])"*/
    ...
    FD1P3XZ bird_y_pos_i0_i9 (.D(n62[10]), .SP(n601), .CK(forty_eight_mhz_counter[19]), 
            .SR(n632), .Q(\bigbird_y_pos[9] ));   /* synthesis lineinfo="@0(39[3],46[10])"*/
    ...
    FD1P3XZ bird_y_pos_i0_i3 (.D(n62[4]), .SP(n601), .CK(forty_eight_mhz_counter[19]), 
            .SR(n632), .Q(\bigbird_y_pos[3] ));   /* synthesis lineinfo="@0(39[3],46[10])"*/
    ...
    FD1P3XZ bird_y_pos_i0_i1 (.D(n62[2]), .SP(n601), .CK(forty_eight_mhz_counter[19]), 
            .SR(n632), .Q(\bigbird_y_pos[1] ));   /* synthesis lineinfo="@0(39[3],46[10])"*/
    ...
    LUT4 i1_2_lut_adj_12 (.A(clappy_c), .B(game_over), .Z(bird_y_pos_9__N_145)) /* synthesis lut_function=(!((B)+!A)) */ ;   /* synthesis lineinfo="@0(40[39],40[83])"*/
    ...
    FD1P3XZ bird_y_pos_i0_i2 (.D(n62[3]), .SP(n601), .CK(forty_eight_mhz_counter[19]), 
            .SR(n632), .Q(\bigbird_y_pos[2] ));   /* synthesis lineinfo="@0(39[3],46[10])"*/
    ...
    FD1P3XZ bird_y_pos_i0_i4 (.D(n62[5]), .SP(n601), .CK(forty_eight_mhz_counter[19]), 
            .SR(n632), .Q(\bigbird_y_pos[4] ));   /* synthesis lineinfo="@0(39[3],46[10])"*/
    ...
    FD1P3XZ is_over_45 (.D(n650), .SP(VCC_net), .CK(forty_eight_mhz_counter[19]), 
            .SR(GND_net_c), .Q(game_over));   /* synthesis lineinfo="@0(39[3],46[10])"*/
    ...
    FD1P3XZ bird_y_pos_i0_i7 (.D(n62[8]), .SP(n601), .CK(forty_eight_mhz_counter[19]), 
            .SR(n632), .Q(\bigbird_y_pos[7] ));   /* synthesis lineinfo="@0(39[3],46[10])"*/
    defparam bird_y_pos_i0_i7.REGSET = "RESET";
    defparam bird_y_pos_i0_i7.SRMODE = "CE_OVER_LSR";
    LUT4 is_over_I_0_1_lut (.A(game_over), .Z(is_over_N_152)) /* synthesis lut_function=(!(A)) */ ;   /* synthesis lineinfo="@0(41[49],41[62])"*/
    ...
    FA2 add_1076_9 (.A0(GND_net), .B0(\bigbird_y_pos[7] ), .C0(bird_y_pos_9__N_145), 
        ...
        .CO1(n1441), .S0(n62[8]), .S1(n62[9]));   /* synthesis lineinfo="@0(40[18],42[48])"*/
    ...
    FA2 add_1076_7 (.A0(GND_net), .B0(\bigbird_y_pos[5] ), .C0(bird_y_pos_9__N_145), 
        ...
        .CO1(n1439), .S0(n62[6]), .S1(n62[7]));   /* synthesis lineinfo="@0(40[18],42[48])"*/
    ...
    FA2 add_1076_5 (.A0(GND_net), .B0(\bigbird_y_pos[3] ), .C0(n1), .D0(n1435), 
        ...
        .S1(n62[5]));   /* synthesis lineinfo="@0(40[18],42[48])"*/
    ...
    FA2 add_1076_3 (.A0(GND_net), .B0(\bigbird_y_pos[1] ), .C0(n1), .D0(n1433), 
        ...
        .S1(n62[3]));   /* synthesis lineinfo="@0(40[18],42[48])"*/
    ...
    FA2 add_1076_1 (.A0(GND_net), .B0(bird_y_pos_9__N_145), .C0(GND_net), 
        ...
        .CI1(n2550), .CO0(n2550), .CO1(n1433));   /* synthesis lineinfo="@0(40[18],42[48])"*/
    ...
    FD1P3XZ bird_y_pos_i0_i6 (.D(n62[7]), .SP(n601), .CK(forty_eight_mhz_counter[19]), 
            .SR(n632), .Q(\bigbird_y_pos[6] ));   /* synthesis lineinfo="@0(39[3],46[10])"*/
...
module testpattern (row_num, \bigbird_y_pos[6] , n14, \bigbird_y_pos[5] , 
    ...
    LUT4 row_i_9__I_0_i8_3_lut (.A(n6_adj_171), .B(RGB_o_5__N_70[3]), .C(row_num[3]), 
         .Z(n8_adj_170)) /* synthesis lut_function=(A (B+!(C))+!A !((C)+!B)) */ ;   /* synthesis lineinfo="@2(30[59],30[79])"*/
    defparam row_i_9__I_0_i8_3_lut.INIT = "0x8e8e";
    LUT4 i3_4_lut (.A(\col_num[9] ), .B(n17), .C(RGB_o_5__N_69), .D(RGB_o_5__N_68), 
         .Z(n584)) /* synthesis lut_function=(!(A+!(B (C (D))))) */ ;   /* synthesis lineinfo="@2(30[22],30[114])"*/
    defparam i3_4_lut.INIT = "0x4000";
    LUT4 row_i_9__I_0_i6_4_lut (.A(RGB_o_5__N_70[1]), .B(RGB_o_5__N_70[2]), 
         .C(row_num[2]), .D(row_num[1]), .Z(n6_adj_171)) /* synthesis lut_function=(!(A (B (C (D))+!B (C+(D)))+!A ((C)+!B))) */ ;   /* synthesis lineinfo="@2(30[59],30[79])"*/
    defparam row_i_9__I_0_i6_4_lut.INIT = "0x0c8e";
    LUT4 row_i_9__I_0_i20_3_lut (.A(n18), .B(RGB_o_5__N_70[9]), .C(row_num[9]), 
         .Z(RGB_o_5__N_69)) /* synthesis lut_function=(A (B+!(C))+!A !((C)+!B)) */ ;   /* synthesis lineinfo="@2(30[59],30[79])"*/
    defparam row_i_9__I_0_i20_3_lut.INIT = "0x8e8e";
    LUT4 i2_2_lut_3_lut (.A(n584), .B(game_over), .C(valid_N_44), .Z(RGB_c_3)) /* synthesis lut_function=(!((B+!(C))+!A)) */ ;   /* synthesis lineinfo="@2(29[11],32[16])"*/
    defparam i2_2_lut_3_lut.INIT = "0x2020";
    LUT4 y_pos_9__I_0_i18_3_lut (.A(n16), .B(row_num[8]), .C(\bigbird_y_pos[8] ), 
         .Z(n18_adj_172)) /* synthesis lut_function=(A (B+!(C))+!A !((C)+!B)) */ ;   /* synthesis lineinfo="@2(30[41],30[54])"*/
    defparam y_pos_9__I_0_i18_3_lut.INIT = "0x8e8e";
    LUT4 y_pos_9__I_0_i20_3_lut (.A(n18_adj_172), .B(row_num[9]), .C(\bigbird_y_pos[9] ), 
         .Z(RGB_o_5__N_68)) /* synthesis lut_function=(A (B+!(C))+!A !((C)+!B)) */ ;   /* synthesis lineinfo="@2(30[41],30[54])"*/
    defparam y_pos_9__I_0_i20_3_lut.INIT = "0x8e8e";
    LUT4 i598_3_lut (.A(valid_N_44), .B(n584), .C(game_over), .Z(RGB_c_1)) /* synthesis lut_function=(A (B+(C))) */ ;   /* synthesis lineinfo="@2(29[11],32[16])"*/
    ...
    LUT4 row_i_9__I_0_i18_3_lut (.A(n16_adj_173), .B(RGB_o_5__N_70[8]), 
         .C(row_num[8]), .Z(n18)) /* synthesis lut_function=(A (B+!(C))+!A !((C)+!B)) */ ;   /* synthesis lineinfo="@2(30[59],30[79])"*/
    ...
    LUT4 row_i_9__I_0_i16_3_lut (.A(n14_adj_174), .B(RGB_o_5__N_70[7]), 
         .C(row_num[7]), .Z(n16_adj_173)) /* synthesis lut_function=(A (B+!(C))+!A !((C)+!B)) */ ;   /* synthesis lineinfo="@2(30[59],30[79])"*/
    defparam row_i_9__I_0_i16_3_lut.INIT = "0x8e8e";
    LUT4 row_i_9__I_0_i14_3_lut (.A(n12_adj_169), .B(RGB_o_5__N_70[6]), 
         .C(row_num[6]), .Z(n14_adj_174)) /* synthesis lut_function=(A (B+!(C))+!A !((C)+!B)) */ ;   /* synthesis lineinfo="@2(30[59],30[79])"*/
